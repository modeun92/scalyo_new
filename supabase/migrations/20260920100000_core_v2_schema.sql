...
--   * WRITE — the structural mirror tables (company … member_authority, subscription) have NO
...
-- ============================================================
-- 12.1 — Every new table exists with RLS on. Expect 23 rows, rls = true on all.
--
...
--
--   drop table if exists public.subscription, public.churn, public.profit, public.issue,
...
--   drop type if exists public.person_title, public.issue_status, public.authority,
