    ...
    <div class="coach-chat">
      <div class="chat-messages" ref="chatRef">
        ...
        <div v-for="msg in messages" :key="msg.id" class="chat-msg" :class="msg.role">
          ...
          <div class="msg-body">
            <div class="msg-text" v-html="formatAiText(msg.content)" />
...
.msg-text :deep(hr) { border: none; border-top: 1px solid var(--border-light); margin: 10px 0; }
.msg-text :deep(code) { background: var(--bg-hover); padding: 1px 5px; border-radius: 4px; font-size: 0.82em; }
