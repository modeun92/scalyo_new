...
export const REGIONAL_MESSAGES = {
  ...
  'fr-BE': {
    portfolio_field_contact_phone: 'Téléphone / GSM',
    smart_import_field_phone: 'Téléphone / GSM',
  },
  ...
  'fr-CH': {
    ...
    quote_title: 'Offres & Propositions',
    quote_new: '+ Nouvelle offre',
    quote_total: 'Total offres',
    quote_empty_title: 'Aucune offre pour le moment',
    quote_empty_note: '0 offre enregistrée · Stockage illimité',
    quote_create_title: 'Nouvelle offre',
    quote_field_title: "Titre de l'offre",
    quote_download_pdf: "Télécharger l'offre PDF",
    quote_delete: 'Supprimer cette offre',
    client_detail_add_quote: 'Offre',
    client_detail_tl_quote: 'Offre : {title} ({status})',
    chat_share_quote: 'Partager une offre',
    ai_ctx_quotes: 'Offres',
    ai_sug_qt1: 'Aide-moi à préparer une offre',
    route_title_quotes: 'Offres — Scalyo',
    oxygen_ferm_p_quotes: '{n} offre(s) créée(s)',
    plan_enterprise_price: 'Sur offre',
    portfolio_field_contact_phone: 'Téléphone / Natel',
    smart_import_field_phone: 'Téléphone / Natel',
  },
  ...
  'fr-CA': {
    ...
    quote_title: 'Soumissions & Propositions',
    quote_new: '+ Nouvelle soumission',
    quote_total: 'Total soumissions',
    quote_empty_title: 'Aucune soumission pour le moment',
    quote_empty_note: '0 soumission enregistrée · Stockage illimité',
    quote_create_title: 'Nouvelle soumission',
    quote_field_title: 'Titre de la soumission',
    quote_download_pdf: 'Télécharger la soumission PDF',
    quote_delete: 'Supprimer cette soumission',
    quote_field_tax: 'Taxes TPS/TVQ (%)',
    country_law_tax_name: 'TPS/TVQ',
    client_detail_add_quote: 'Soumission',
    client_detail_tl_quote: 'Soumission : {title} ({status})',
    chat_share_quote: 'Partager une soumission',
    ai_ctx_quotes: 'Soumissions',
    ai_sug_qt1: 'Aide-moi à préparer une soumission',
    route_title_quotes: 'Soumissions — Scalyo',
    oxygen_ferm_p_quotes: '{n} soumission(s) créée(s)',
    plan_enterprise_price: 'Sur soumission',
    profile_email: 'Courriel',
    setting_email: 'Courriel',
    email_studio_copy: 'Copier le courriel',
    email_studio_subject_placeholder: 'Objet du courriel...',
    email_studio_body_placeholder: "Rédigez votre courriel ou utilisez l'IA pour générer le contenu...",
    email_studio_send_title: 'Envoyer le courriel',
    email_studio_send_btn: 'Envoyer le courriel →',
    email_studio_send_success: 'Courriel envoyé avec succès !',
    email_studio_history_sent: 'Courriels envoyés',
    email_studio_history_opened: 'Courriels ouverts',
    email_studio_history_empty: "Aucun courriel envoyé pour l'instant",
    ...
    planning_settings_hide_weekends: 'Masquer les fins de semaine',
  },
  ...
  'en-GB': {
    customize: 'Customise',
    dashboard_customize_kpis: 'Customise',
    ...
    smart_import_subtitle: 'Import any complex file — Scalyo automatically analyses and routes your data',
    roadmap_color: 'Colour',
    smart_matrix_project_color: 'Colour',
    copil_cover_color: 'Theme colour',
    planning_event_color: 'Colour',
    planning_color_by: 'Colour by',
    setting_billing_managed_by_owner: 'Billing is managed by the organisation owner',
    ...
    oxygen_team_disabled_body: 'The Oxygen team view is not enabled for your organisation yet.',
