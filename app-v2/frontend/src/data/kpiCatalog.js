...
export const KPI_CATALOG = [
  // ── REVENUE ──
  { id: 'arr', source: 'auto', label: 'ARR', labelEN: 'ARR', labelKO: '연간 반복 수익', cat: 'revenue', unit: null, format: 'currency', roles: ['csm','kam','commercial','manager'], sectors: ['b2b','saas'] },
  { id: 'mrr', source: 'auto', label: 'MRR', labelEN: 'MRR', labelKO: '월간 반복 수익', cat: 'revenue', unit: null, format: 'currency', roles: ['csm','kam','commercial','manager'], sectors: ['b2b','saas'] },
  { id: 'revenue_total', source: 'auto', label: 'CA Total', labelEN: 'Total Revenue', labelKO: '총 매출', cat: 'revenue', unit: null, format: 'currency', roles: ['manager','commercial'], sectors: ['b2b','b2c','retail'] },
  ...
  { id: 'acv', source: 'manual', agg: 'avg', label: 'ACV', labelEN: 'ACV', labelKO: '연간 계약 가치', cat: 'revenue', unit: null, format: 'currency', roles: ['commercial','kam'], sectors: ['b2b','saas'] },
  { id: 'ltv', source: 'manual', agg: 'avg', label: 'LTV', labelEN: 'LTV', labelKO: '고객 생애 가치', cat: 'revenue', unit: null, format: 'currency', roles: ['csm','kam','manager'], sectors: ['b2b','b2c','saas'] },
  ...
  { id: 'arpu', source: 'manual', agg: 'avg', label: 'ARPU', labelEN: 'ARPU', labelKO: '사용자당 평균 수익', cat: 'revenue', unit: null, format: 'currency', roles: ['manager','commercial'], sectors: ['b2c','saas','marketplace'] },
  { id: 'gmv', source: 'manual', agg: 'sum', label: 'GMV', labelEN: 'GMV', labelKO: '총 상품 거래량', cat: 'revenue', unit: null, format: 'currency', roles: ['manager','commercial'], sectors: ['marketplace','ecommerce'] },
  ...
  { id: 'churn_revenue', source: 'manual', agg: 'sum', label: 'Churn Revenue', labelEN: 'Revenue Churn', labelKO: '수익 이탈', cat: 'retention', unit: null, format: 'currency', roles: ['csm','manager'], sectors: ['b2b','saas'], inverse: true },
  ...
  { id: 'cac', source: 'manual', agg: 'avg', label: 'CAC', labelEN: 'CAC', labelKO: '고객 획득 비용', cat: 'acquisition', unit: null, format: 'currency', roles: ['commercial','manager'], sectors: ['b2b','b2c'], inverse: true },
  ...
  { id: 'pipeline_value', source: 'auto', label: 'Pipeline', labelEN: 'Pipeline Value', labelKO: '파이프라인', cat: 'acquisition', unit: null, format: 'currency', roles: ['commercial','manager'], sectors: ['b2b'] },
  ...
  { id: 'arr_expansion', source: 'manual', agg: 'sum', label: 'ARR Expansion', labelEN: 'Expansion ARR', labelKO: '확장 ARR', cat: 'expansion', unit: null, format: 'currency', roles: ['csm','kam'], sectors: ['b2b','saas'] },
  ...
  { id: 'arr_per_csm', source: 'auto', label: 'ARR/CSM', labelEN: 'ARR per CSM', labelKO: 'CSM당 ARR', cat: 'team', unit: null, format: 'currency', roles: ['manager'], sectors: ['b2b','saas'] },
  ...
  { id: 'aov', source: 'manual', agg: 'avg', label: 'Panier Moyen', labelEN: 'Avg Order Value', labelKO: '평균 주문 금액', cat: 'ecommerce', unit: null, format: 'currency', roles: ['commercial','manager'], sectors: ['ecommerce','b2c','retail'] },
