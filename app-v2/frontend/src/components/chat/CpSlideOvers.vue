  ...
  <teleport to="body">
    ...
    <div v-if="showCreateTask" class="chat_panel_overlay" @click.self="$emit('close-create-task')">
      <div class="chat_panel_slide">
        ...
        <label class="chat_panel_label">{{ t('chat_task_title') }}</label>
        <input v-model="taskTitle" class="chat_panel_field" />
        <label class="chat_panel_label">{{ t('chat_task_priority') }}</label>
        ...
        <label class="chat_panel_label">{{ t('chat_task_due') }}</label>
        <input v-model="taskDue" type="date" class="chat_panel_field" />
        <button class="chat_panel_button_primary" :disabled="!taskTitle.trim()" @click="createTask">{{ t('create') }}</button>
      </div>
    </div>
  </teleport>
</template>
