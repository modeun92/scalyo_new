...
> **This is the OLD schema**, still the source of truth for the app. The new core schema that is
> replacing it table by table is drawn in [`DATABASE_DIAGRAM_CORE_V2.md`](DATABASE_DIAGRAM_CORE_V2.md).
