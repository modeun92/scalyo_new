...
-- ==========================================================================
-- org_email_config   [7 columns | 0 confirmed | code only]
-- ==========================================================================
...
-- ==========================================================================
-- organization_members   [7 columns | 0 confirmed | code only]
-- ==========================================================================
...
-- ==========================================================================
-- organizations   [15 columns | 1 confirmed | ALTER only + code]
-- ==========================================================================
CREATE TABLE IF NOT EXISTS public.organizations (
  id                         uuid,   -- type inferred
  is_founding                boolean,   -- type inferred
  maxClients                 text,   -- type inferred, single call site
...
-- ==========================================================================
-- profiles   [18 columns | 1 confirmed | ALTER only + code]
-- ==========================================================================
...
CREATE TABLE IF NOT EXISTS public.tasks (
  id                         uuid,   -- type inferred
  actual_hours               text,   -- type inferred, single call site
  ...
  due_date                   text,   -- type inferred, single call site
  end_date                   text,   -- type inferred, single call site
  expected_hours             text,   -- type inferred, single call site
  finished                   text,   -- type inferred, single call site
  importance                 text,   -- type inferred, single call site
  level                      text,   -- type inferred, single call site
  max_hours                  text,   -- type inferred, single call site
  min_hours                  text,   -- type inferred, single call site
  name                       text,   -- type inferred, single call site
  ...
  start_date                 text,   -- type inferred, single call site
  status                     text,   -- type inferred
